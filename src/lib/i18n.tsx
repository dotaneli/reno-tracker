...
const dict = {
  ...
  "task.moveToRoot": { en: "Drop here to move to root level", he: "שחרר כאן להעברה לרמת השורש" },
  ...
  "team.inviteHint": {
    en: "Invite anyone by email. If they don't have an account yet, they'll get access automatically when they sign in with Google.",
    he: "הזמן כל אחד לפי אימייל. אם אין להם חשבון עדיין, הם יקבלו גישה אוטומטית כשיתחברו עם Google.",
  },
  "team.pendingSignup": {
  ...
  "costs.unscheduledTasks": { en: "No Payments Scheduled", he: "ללא תשלומים מתוכננים" },
  ...
  "prop.deleteFloorConfirm": { en: "Delete floor \"{name}\" and all its rooms?", he: "למחוק את הקומה \"{name}\" וכל חדריה?" },
  ...
  "hist.rollbackConfirm": { en: "Rollback to \"{label}\"? Your current state will be auto-saved first — nothing will be lost.", he: "לשחזר ל\"{label}\"? המצב הנוכחי יישמר אוטומטית — שום דבר לא יאבד." },
  "hist.noVersions": { en: "No checkpoints yet. Save your first version.", he: "אין נקודות ביקורת. שמור את הגרסה הראשונה שלך." },
  ...
  "integ.noConnections": { en: "No connections yet. Set up an AI assistant above.", he: "אין חיבורים עדיין. הגדר עוזר AI למעלה." },
  "integ.revoke": { en: "Revoke", he: "בטל" },
  "integ.revokeConfirm": { en: "Revoke this connection? The AI assistant will no longer be able to access your project.", he: "לבטל חיבור זה? עוזר ה-AI לא יוכל יותר לגשת לפרויקט שלך." },
  ...
  "integ.keyWarning": { en: "Copy this key now — you won't see it again!", he: "העתק את המפתח עכשיו — לא תראה אותו שוב!" },
